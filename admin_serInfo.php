...
if ($cur_page > 1) 
{
$page_links .= '<a href="admin_serinfo.php?page=' . ($cur_page - 1) . '">PREV</a> ';
}
...
{
$page_links .= ' <a href="admin_serinfo.php?page=' . $i . '"> ' . $i . '</a>';
}
}

// If this page is not the last page, generate the "next" link
if ($cur_page < $num_pages) {
$page_links .= ' <a href="admin_serinfo.php?page=' . ($cur_page + 1) . '">NEXT</a>';
}
return $page_links;
}
...
?>
<main role="ServiceInfo" id="ServiceInfo">
<div class="container-fluid  minHeigh pt-4 pb-5">
    <h1 class="txt-dark text-center py-5">Services Information Table</h1>
	<?php
	//print $msg;
			...
			while($x=mysqli_fetch_array($res))
			{
				print"<tr class='HovSty text-center'>
					...
					<td class='text-center'>
						<img src='adminUploads/$x[Ser_Pic]' width='50px' />
					</td>
					<td>
						<a class='updateCls txt-green' 
						href='admin_AddService.php?sid=$x[Ser_Id]'>
							<i title='Update Row' class='fas fa-edit'></i>
						</a>
					</td>
					<td>
						<a class='deleteCls txt-orange' id='$x[Ser_Id]' href=''>
